...
//user
export const postNotificationUser = asyncHandler(async(
  req:Request,
  res:Response,
  next:NextFunction) => {
      try{
...
export const getNotificationUser = asyncHandler(async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
//admin
export const postNotificationAdmin = asyncHandler(async(
  req:Request,
  res:Response,
  next:NextFunction) => {
      try{
...
export const getNotificationAdmin = asyncHandler(async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
