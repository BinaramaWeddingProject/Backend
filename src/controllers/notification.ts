...
export const getNotification = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const vendorUserIds = vendorNotifications.map(
      ...
      const venueUserIds = venueNotifications.map(
        (notification) => notification.userId
      );
...
export const postNotificationVendor = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const getNotificationVendor = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const postNotificationVenue = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const getNotificationVenue = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { id } = req.params; // Assuming the ID is passed as a URL parameter
...
//user
export const postNotificationUser = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { userId, venueId, message } = req.body;
...
//admin
export const postNotificationAdmin = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const updateAdminNotification = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { id } = req.body;
