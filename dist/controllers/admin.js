...
export const updateAdminProfileById = async (req, res) => {
    try {
        const updatedProfile = await AdminModel.findOneAndUpdate({ _id: req.params.id }, { $set: { 'profile': req.body } }, { new: true });
        if (updatedProfile) {
...
export const updateAdminVenuePermissionsById = async (req, res) => {
    try {
        const updatedPermissions = await AdminModel.findOneAndUpdate({ _id: req.params.id }, { $set: { 'venue': req.body } }, { new: true });
